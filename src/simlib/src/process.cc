...
/// \fn THREAD_DEBUG_f
/// we need this because optimization of volatile global variable access
/// after longjmp -> setjmp transition in 32bit i686 mode of GCC 7+
/// TODO: +string table
...
static void THREAD_DEBUG_f(int n) {
    ...
    case 1:
        ...
        DEBUG(DBG_THREAD,("|   %d) - stack size = %p", n, P_StackSize));
        break;
    case 2:
        break;
    case 3:
        break;
    case 4:
        DEBUG(DBG_THREAD,("|   %d) THREAD_SAVE_STACK: before setjmp() - context=%p", n, P_Context));
        break;
    case 5:
        DEBUG(DBG_THREAD,("|   %d) THREAD_SAVE_STACK: after setjmp()  - context=%p", n, P_Context));
        break;
    case 6:
        DEBUG(DBG_THREAD,("|   %d) THREAD_RESTORE: longjmp() back     - context=%p", n, P_Context));
        break;
    case 7:
    ...
    case 0xB:
        DEBUG(DBG_THREAD,("| b) THREAD Shift SP to %p ", P_StackBase2));
        break;
    case 0xC:
        DEBUG(DBG_THREAD,("| c) THREAD Before longjmp(%p,1)", P_Context->status));
        break;

    default:
        DEBUG(DBG_THREAD,("|   %d) - context = %p", n, P_Context));
        break;
    }
}
#else
...
void Process::_Run() throw() // no exceptions
{
    ...
    //              +-> +----------+
    //              |   |          |
#   define STACK_RESERVED 0x200 // reserved for "red zone" ?
    //              |   |          |
    // P_StackBase2 +-> +----------+
