...
Pomocí experimentu bylo zjištěno, že se z hlediska finančního výdělku vyplatí zaměstnat méně zkušenější kuchaře, kteří objednávky vyřizují pomaleji. Byly provedeny 3 simulace, při níž restaurace zaměstnávala 2 zaměstnance. Jednotlivé výdaje a výdělky jsou podrobně uvedeny v tabulkách \ref{tab:4}, \ref{tab:5} a \ref{tab:6}.
