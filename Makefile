...
PARAMS1 = -car-type diesel -car-num 0 -chef-num 3 -chef-pause 5 -chef-center 15 -chef-sigma 3 -order-center 10 -order-wait 30 -car-delivery-center 4 -car-delivery-sigma 1 -car-refuel-center 12 -car-refuel-sigma 2 -start-time 11 -stop-time 21 -car-capacity 10 -pause-interval 60 -day-num 7 -earnings-center 270 -earnings-sigma 30 -monthly-car-expenses 1900 -chefs-salary 300 -deliverers-salary 150
